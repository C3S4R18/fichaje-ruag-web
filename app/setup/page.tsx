...
export default function SetupProfileWeb() {
  ...
  // --- NUEVO: Estado para verificar la memoria antes de mostrar el formulario ---
  ...
  // --- NUEVO: Verificar si ya tiene cuenta apenas entra a la página ---
  useEffect(() => {
  ...
  // --- NUEVO: Pantalla de carga mientras revisa la memoria ---
  if (isChecking) {
    return (
